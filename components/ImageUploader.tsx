...
import { UploadIcon, LoadingSpinner, ResetIcon } from './icons';
...
export const ImageUploader: React.FC<ImageUploaderProps> = ({ imageUrl, onImageSelect, onReset, isLoading, error, hasImage, disabled }) => {
